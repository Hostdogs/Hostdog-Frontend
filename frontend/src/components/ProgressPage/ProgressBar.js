...
const gif=['/congrat.gif','/waiting.gif','/onhost.gif','./wavecall.gif','/bye.gif','/sad.gif']
  ...
  return (
    <div>
      ...
      <h2>{progressLabel[labelIndex]}</h2>
          <Container>
          <img src={process.env.PUBLIC_URL + gif[gifIndex]}  width="40%" height="40%" />
    ...
    <Button onClick={handleProgress} style={{ position: "fixed", bottom: 0, right: 0 }} >Progress</Button>
    </div>
  );
}
